...
// Menu items
const char* mainMenuItems[] = {"Input Config", "Output Config", "Timer/Delay Config", "Date/Time Config", "Auto Silence Config", "Chime Config", "Password Config", "Panel Info Config", "History View Setting", "Factory Reset"};
...
void handleLevel1(char key) {
  switch (key) {
    case '4': selectedItemLevel1 = max(0, selectedItemLevel1 - 1); break;
    case '6': selectedItemLevel1 = min(2, selectedItemLevel1 + 1); break;
...
void handleLevel2(char key) {
  switch (key) {
    case '4': selectedItemLevel2 = max(0, selectedItemLevel2 - 1); break;
    case '6': selectedItemLevel2 = min(2, selectedItemLevel2 + 1); break;
...
void handleLevel3(char key) {
  switch (key) {
    case '4': selectedItemLevel3 = max(0, selectedItemLevel3 - 1); break;
    case '6': selectedItemLevel3 = min(1, selectedItemLevel3 + 1); break;
    case 'A': 
